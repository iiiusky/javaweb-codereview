...
public class FileServiceServiceLocator extends org.apache.axis.client.Service implements org.javaweb.codereview.axis.client.FileServiceService {
	...
	public org.javaweb.codereview.axis.client.FileService_PortType getFileService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
		try {
			org.javaweb.codereview.axis.client.FileServiceSoapBindingStub _stub = new org.javaweb.codereview.axis.client.FileServiceSoapBindingStub(portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (org.javaweb.codereview.axis.client.FileService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
				org.javaweb.codereview.axis.client.FileServiceSoapBindingStub _stub = new org.javaweb.codereview.axis.client.FileServiceSoapBindingStub(new java.net.URL(FileService_address), this);
				_stub.setPortName(getFileServiceWSDDServiceName());
				return _stub;
			}
